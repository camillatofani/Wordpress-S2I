...
<div class="header-page" style="background: url('<?php echo $backgroundImg[0]; ?>') no-repeat; background-size: cover; background-position: center; background-attachment: fixed;">
    <h2><?php the_title(); ?></h2>
        ...
        <div class="contain">
            ...
            <div class="col-1"><h3><?php echo get_post_meta($post->ID, 'intro-text', true); ?></h3></div>
        ...
        <div class="contain">
            ...
            <div class="col-1"><img class="img-radius" src="<?php echo get_post_meta($post->ID, 'img-team', true); ?>" width="100%" /></div>
